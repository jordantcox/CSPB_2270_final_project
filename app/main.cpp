...
int main(){
    ...
    test_airport_1.Insert(heap_1, "AAA_BBB", 10.00, 10.90, 500);  
    test_airport_1.Insert(heap_1, "AAA_CCC", 10.50, 11.90, 500); 
    test_airport_1.Insert(heap_1, "AAA_DDD", 12.00, 12.90, 500); 
    test_airport_1.Insert(heap_1, "AAA_EEE", 9.00, 9.90, 500);
    test_airport_1.Insert(heap_1, "AAA_FFF", 8.00, 8.90, 500);  
    test_airport_1.Insert(heap_1, "AAA_GGG", 17.00, 17.90, 500); 
    test_airport_1.Insert(heap_1, "AAA_HHH", 15.00, 15.90, 500); 
    ...
    cout << "Number of chargers: " << test_airport_1.Calculate_Chargers(heap_1) << endl;
    ...
    cout << "Number of chargers: " << test_airport_2.Calculate_Chargers(heap_2) << endl;
